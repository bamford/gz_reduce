...
GamaTree = new DecisionTree 'gama', ->
  @question 'Features', 'Is the galaxy in the centre of the image simply smooth and rounded, or does it have features?', ->
  ...
  @question 'EdgeOn', 'Could this be a disk viewed edge-on?', ->
  ...
  @question 'SpiralWinding', 'How tightly wound do the spiral arms appear?', leadsTo: 'How many spiral arms are there?', ->
  ...
  @question 'SpiralNumber', 'How many spiral arms are there?', leadsTo: 'How prominent is the central bulge, compared with the rest of the galaxy?', ->
  ...
  @question 'BulgeShape', 'Does the galaxy have a bulge at its centre?', leadsTo: 'Is the galaxy currently merging or is there any sign of tidal debris?', ->
  ...
  @question 'OddType', 'Do you see any of these odd features in the image?', ->
